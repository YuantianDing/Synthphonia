...
use crate::{
    expr::{ops::Op3, Expr}, forward::{enumeration::Enumerator3, executor::Enumerator}, galloc::{AllocForExactSizeIter, AllocForStr}, new_op3, parser::config::Config, value::Value
};
...
impl Enumerator3 for Replace {
    fn enumerate(&self, this: &'static crate::expr::ops::Op3Enum, exec: Arc<Enumerator>, nt: [usize; 3]) -> Result<(), ()> {
